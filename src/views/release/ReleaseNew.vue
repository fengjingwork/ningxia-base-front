<template>
  <div class="release user-box">
    <div class="user-box-title" style="display:flex;justify-content:space-between">
      <span><i class="el-icon-menu"></i> 发布政策列表</span>
      <el-button type="primary" class="release-button" @click="getDetail">政策发布</el-button>
    </div>
    ...
    <div class="user-table table">
      <el-table :data="tableListData" stripe style="width: 100%" header-row-class-name="thead">
        ...
        <el-table-column prop="releaseDateStr" label="操作" width="210" header-align="center" align="center">
          <template slot-scope="scope">
            <el-button type="primary" size="mini" @click="getDetail(scope.row)" style="background:#409eff;border-color:#409eff">修改</el-button>
